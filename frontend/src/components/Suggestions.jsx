...
import { isRead, langFilterAvailable, PERIOD_OPTIONS, RATING_OPTIONS } from '../mediaMeta.js'
...
function Suggestions({ title = 'Consigliati per te', mediaType = 'tv' }) {
  ...
  const buildOpts = useCallback(
    (exclude) => {
      ...
      if (onlyIt && showLangFilter) opts.lang = 'it'
      if (exclude) opts.exclude = exclude
      return opts
    },
    [sort, minRating, period, onlyIt, showLangFilter],
  )
